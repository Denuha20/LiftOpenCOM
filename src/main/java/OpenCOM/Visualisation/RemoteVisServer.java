...
import OpenCOM.ReflectionMessages.*;
/**
...
public class RemoteVisServer implements Runnable{
                            ...
                            if (selectedKeys[i].equals(acceptKey)){
                                ...
                                try{
                                    ...
                                    byte[] size = readFully(clientChannel, 4);
                                        ...
                                        ReflectionMessage msg = null;
                                        try{
                                            msg = (ReflectionMessage) inStream.readObject();
    ...
    public void handleData(SocketAddress sender, ReflectionMessage data){
